            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <success-alert :show="isSucced" :response="msg">
                        <p>Enregistrement du tutoriel réussi</p>
                    </success-alert>
                    <error-alert-2 :show="isError" :response="msg"></error-alert-2>
                    <form>
                        <div class="mb-3">
                            <label for="title" class="col-form-label" :class="[v$.title.$error ? 'text-danger' : '']" >Titre*</label>
                            <input type="text" class="form-control" id="title" v-model.trim="state.title" :class="[v$.title.$error ? 'is-invalid' : '']">
                        ...
                        <div class="modal-footer">
                            ...
                            <submit-btn-component :loading="btnLoading" type="button" class="btn btn-success" @click="saveTuto">Sauvegarder</submit-btn-component>
                        </div>
                    </form>
                </div>
            </div>
