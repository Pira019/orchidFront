<template>
    <div>
            ...
            <form class="mx-5 my-5" novalidate v-on:submit.prevent="submit">
                <div class="row mb-3" id="place">
                    <div class="col">
                        ...
                        <select class="form-select" id="pays" v-model.number="state.country_id" @change="loadCities" :class="[v$.country_id.$error ? 'is-invalid' : '']">
                            <option selected value="" disabled>Choisir un pays...</option>
                ...
                <div class="row mb-3">
                    <div class="col">
                        <label for="university">Nom université*</label>
                        <input type="text" class="form-control" id="university"  placeholder="Ex : Université de montréal, Université de kinshasa ...">
                    </div>
                    <div class="col">
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <div>
                        <submit-btn-component class="btn btn-success m-2" type="submit"  @click="save">Enregister</submit-btn-component>
                    </div>
