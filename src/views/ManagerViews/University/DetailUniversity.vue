    ...
    <university-layout :isShowBtn="true" :title="'Détail de l\'université'">
      ...
      <div>
        ...
        <div id="info" class="mb-5">
          <h2 class="display-6"> {{ university.name }}  <span v-if="university.shortName">( {{university.shortName }} )</span></h2>          
        </div>
        ...
        <div class="tab-content mt-5" id="myTabContent">
          ...
          <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
            <div>
              ...
              <p>Site web :  <a :href="university.webSite" target="_blank" class="text-success fw-bold"> {{ university.webSite }}  </a> </p>
          ...
          <div class="tab-pane fade" id="Adresse" role="tabpanel" aria-labelledby="Adresse-tab">
            <div>
              <h3 class="h6 mb-3">{{ university.name }}</h3>
              <p>Pays :  <span class="fw-bold">{{ university.city.country.name }}</span> <img :src="university.city.country.flag_url" alt="drappeau pays" class="img-fluid mx-3" width="35"> </p> 
...
export default {
  ...
  components: { ErrorModalComponent, UniversityLayout, Spinner },
  data() {
    return {
